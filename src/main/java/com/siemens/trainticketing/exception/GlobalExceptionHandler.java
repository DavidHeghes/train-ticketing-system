...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleStartStationNotFound(StartStationNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(ex.getMessage());
    }

    @ExceptionHandler(EndStationNotFoundException.class)
    public ResponseEntity<String> handleEndStationNotFound(EndStationNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(ex.getMessage());
    }
